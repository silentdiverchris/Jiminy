...
There is a default project called 'No project' which all itrems will be added to if they are no given a project.
...
You can also re-define projects in appsettings.json as below, which allows you to customise how they are presented and what order they are shown in.

Pre-defining projects is the only way to end up with a project whose name has a space in it, since spaces are taken as a terminator of a tag set, at least right now.

...
//            sb.Append(GenerateListTable("Someday/maybe", projectItems, onlyBucket: enBucket.Maybe, showText: true, showPriority: true, showLinks: true, suppressProjectName: project is not null));
//            sb.Append("</div></div>");
...
//                sb.Append(GenerateListTable("Maybe", items, onlyBucket: enBucket.Maybe, showText: true, showPriority: true, showLinks: true, suppressProjectName: false));
//            }
//            else
//            {
...
//        private static HtmlTableCell GenerateTextCell(Item item, bool suppressProjectName = false)
//        {
//            StringBuilder sbIcons = new(2000);

//            string? diags = "Diagnostics: " + string.Join(", ", item.Diagnostics);

//            string? warnings = string.IsNullOrEmpty(item.Warnings)
//                ? null
//                : $"<br><p class='tag-warning'>{string.Join("<br>", item.Warnings)}</p>";
...
//            {
//                sbIcons.Append(TagSetUtilities.GetTagIconHtml(ti));
//            }
...
//            if (item.Bucket != enBucket.None)
//            {
//                string bucketIcon = item.Bucket switch
//                {
//                    enBucket.In => TagSetUtilities.CustomiseIcon(TagSetUtilities.GetInBucketHtml(fillColour: "orangered"), tipText: $"Bucket: {item.Bucket}"),
//                    enBucket.Next => TagSetUtilities.CustomiseIcon(TagSetUtilities.GetNextBucketHtml(fillColour: "orangered"), tipText: $"Bucket: {item.Bucket}"),
//                    enBucket.Waiting => TagSetUtilities.CustomiseIcon(TagSetUtilities.GetWaitingBucketHtml(fillColour: "orangered"), $"Bucket: {item.Bucket}"),
//                    enBucket.Maybe => TagSetUtilities.CustomiseIcon(TagSetUtilities.GetMaybeBucketHtml(fillColour: "orangered"), tipText: $"Bucket: {item.Bucket}"),
//                    _ => ""
//                };
...
//            {
//                enPriority.High => TagSetUtilities.CustomiseIcon(TagSetUtilities.GetPriorityHighIconHtml(fillColour: "orangered"), tipText: $"Priority: {item.Priority}"),
//                enPriority.Medium => TagSetUtilities.CustomiseIcon(TagSetUtilities.GetPriorityMediumIconHtml(fillColour: "purple"), tipText:  $"Priority: {item.Priority}"),
//                enPriority.Low => TagSetUtilities.CustomiseIcon(TagSetUtilities.GetPriorityLowIconHtml(fillColour: "darkgrey"), tipText: $"Priority: {item.Priority}"),
//                _ => ""
//            };
//            sbIcons.Append(priorityIcon);

//            sbIcons.Append(TagSetUtilities.CustomiseIcon(TagSetUtilities.GetLinkIconHtml(), tipText: "Open the source MarkDown file", linkUrl: item.FullFileName));
